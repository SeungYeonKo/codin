...
public class ActionExample : MonoBehaviour
{
    void Start()
    {
        ...
        // 입력 : T타입
        // 반환 : 없음
        // 반드시 반환값이 없고, 매개 변수를 0~16개인 메서드를 담을 수 있는 대리자
        Action a = Eat;
        a += () =>                   // "익명함수"라고도 부른다
        {
            Debug.Log("먹었다!");
        ...
        {
            Debug.Log($"{foodName}을 먹었당~~");
        };
        // 람다식은 접근자, 함수이름, 반환문(return)이 없다.
        // 코드를 더 가독성있게 만들거나 함수가 매개변수로 딱 한 번 쓰일 때 쓴다.

        b.Invoke("마라탕");

        // 매개변수를 최대 16개까지 입력 받을 수 있다
        ...
        // F(x, y) = x^2 + y^2
        // F(2, 3) => 13
        // F(string foodname) => Debug.Log($"{foodName}을 먹었당~~")
    }
    public void Eat()
    {
        Debug.Log("먹었당~~");
